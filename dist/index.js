import { nameForSerialization, DefaultSerializeable, Feedback, ignoreFromSerialization, CameraSettings, FactoryMaker, Brush, BaseController, Color } from 'scandit-capacitor-datacapture-core/dist/core';
...
class NativeIdCaptureListenerProxy {
    ...
    async subscribeDidRejectListener() {
        this.didRejectListener = await window.Capacitor.Plugins[Capacitor.pluginName]
